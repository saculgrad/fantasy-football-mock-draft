...
export function LeagueConfigForm({ onSave, locked = false }: LeagueConfigFormProps) {
  ...
  return (
    <div className="league-config-form">
      {locked && (
        <p className="hint locked-notice">
          League settings are locked while a draft is in progress. Abandon or complete the draft to make changes.
        </p>
      )}
      <fieldset className="league-config-fieldset" disabled={locked}>
        <section>
          <h2>League setup</h2>
